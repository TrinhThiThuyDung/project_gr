...
<nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand page-scroll" href="#page-top">Phuot</a>
        </div>

        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse custom-start navbar-collapse" id="bs-example-navbar-collapse-1">
...
<header>
    <div class="header-content">
        <div class="header-content-inner">
            <h1>phuot</h1>
            <hr>
            <p style="color: green;">Start Bootstrap can help you build better websites using the Bootstrap CSS framework! Just download your template and start going, no strings attached!</p>
            <a href="#signin" class="btn btn-primary btn-xl page-scroll">Find Out More</a>
        </div>
    </div>
</header>

<section class="bg-primary" id="signin">
    <div class="container">
        <div class="row">
